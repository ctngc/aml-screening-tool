...
# AML Screening Tool
A personal project that simulates common AML compliance tasks using a database: screening customers against a sanctions list and
...
- Detection of suspicious patterns in transaction history:
  structuring, unusual amounts, abnormal frequency
